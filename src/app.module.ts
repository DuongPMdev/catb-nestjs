...
@Module({
  imports: [
    TypeOrmModule.forRoot({
      ...
      password: 'NGen2024@',
      database: 'plays_hub',
      entities: [ Account, Currency, Friend, Transaction, GameCatLuckyStatistic, GameCatLuckyConfigShop, GameCatBattleStatistic, PlaysHubConfigQuest, PlaysHubProgressQuest ],
      synchronize: false, // never change it to true : true will force clear db
    }),
    TypeOrmModule.forFeature([Account, Currency, Friend, Transaction, GameCatLuckyStatistic, GameCatLuckyConfigShop, GameCatBattleStatistic, PlaysHubConfigQuest, PlaysHubProgressQuest]),
